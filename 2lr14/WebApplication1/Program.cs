...
using WebApplication1.Checkers;
using Quartz;
using Quartz.Impl;
...
builder.Services.AddScoped<ICurrencyService, WebApplication1.Services.CurrencyService>(); // Для використання DI
...
builder.Services.AddHostedService<WebCheckerService>();
builder.Services.AddHttpClient<WebCheckerService>();

builder.Services.AddSingleton<ISchedulerFactory, StdSchedulerFactory>();
builder.Services.AddSingleton<QuartzConfigurator>();
